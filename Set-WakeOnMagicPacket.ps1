...
if ((Get-NetAdapterPowerManagement -Name $NetAdapter.Name).WakeOnMagicPacket -eq 'Disabled') {
    Set-NetAdapterPowerManagement -Name $NetAdapter.Name -WakeOnMagicPacket Enabled
}
